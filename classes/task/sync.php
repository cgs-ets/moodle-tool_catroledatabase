...
/**
 * Category role database tool - sync.
 *
 ...
 */
namespace tool_catroledatabase\task;
...
class sync extends \core\task\scheduled_task {
    ...
    public function get_name() {
        ...
        return get_string('sync', 'tool_catroledatabase');
    }
    /**
     * Execute the task.
     */
    public function execute() {
        ...
        $catroledatabase = new \tool_catroledatabase_sync();
